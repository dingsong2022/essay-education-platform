    ...
    if not st.session_state.logged_in:
        ...
        with tab3:
            ...
            with st.expander("📄 개인정보처리방침 보기"):
                st.markdown("""
**개인정보처리방침** | 시행일: 2026년 3월 24일 | 제작·운영: 용인신촌중학교 송지은
...
**제5조 이용자의 권리 및 행사 방법**
이용자(학생) 및 법정대리인은 언제든지 열람·정정·삭제·처리정지를 요구할 수 있습니다.
권리 행사는 담임교사 또는 운영 교사에게 서면·이메일 등으로 요청하실 수 있으며, 운영 교사는 지체 없이 조치합니다.

**제6조 만 14세 미만 아동의 개인정보 보호**
만 14세 미만 아동의 개인정보를 수집할 경우, 「개인정보 보호법」 제22조의2에 따라 법정대리인의 동의를 받아야 합니다.
본 앱은 학교 수업 활동의 일환으로 운영되므로, 학교에서 배부하는 가정통신문 또는 학교 내 개인정보 수집 동의서를 통해 법정대리인 동의를 갈음합니다.
...
*본 개인정보처리방침은 「개인정보 보호법」 제30조에 따라 작성되었습니다.*
            ...
            with st.form("register_form"):
                ...
                agree_privacy = st.checkbox("개인정보처리방침에 동의합니다 (필수)", key="agree_privacy")

                submitted = st.form_submit_button("📝 회원가입", use_container_width=True)

                if submitted:
                    if not agree_privacy:
                        st.error("개인정보처리방침에 동의해야 회원가입이 가능합니다.")
                    elif not all([new_username, new_password, confirm_password, name]):
...
**제1조 수집하는 개인정보 항목 및 수집·이용 목적**
수집 항목: 아이디, 이름 | 목적: 학습 활동 기록 저장 및 관리, 학습 결과 확인, 이용자 식별 | 수집 방법: 이용자가 앱 이용 시 직접 입력
최소처리 원칙: 서비스 제공에 필요한 최소한의 정보만 수집하며, 위 항목 외의 개인정보는 수집하지 않습니다.
...
**제3조 개인정보의 제3자 제공 및 처리 위탁**
수집된 개인정보는 명시된 목적 이외에 제3자에게 제공하지 않습니다. 다만, 데이터 저장을 위해 아래 외부 서비스를 활용하고 있으며, 해당 서비스의 개인정보처리방침이 함께 적용됩니다.
- 수탁 업체: Google LLC (Google Sheets / Firebase 등) | 위탁 업무: 학습 데이터 저장 및 관리
- 보유 기간: 위탁 계약 종료 또는 서비스 종료 시까지
- 참고: Google 개인정보처리방침 — policies.google.com/privacy
...
**제7조 개인정보 보호책임자**
보호책임자: 용인신촌중학교 송지은 | 연락처: dingsong@yshinchon.ms.kr / 031-8025-4710
소속 기관: 용인신촌중학교, 경기도 용인시
개인정보 침해 신고: 개인정보 침해신고센터 — privacy.kisa.or.kr / ☎ 118
